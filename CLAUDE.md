# ALICE-Bio — Claude Code 設定

## プロジェクト概要

Molecular structure as signed distance functions amino acid energy potentials folding SDF
...
| バージョン | 0.1.0 |
| ライセンス | AGPL-3.0-only |
| リポジトリ | `ext-sakamoro/ALICE-Bio` |
| Eco-Systemブリッジ | `bridge_bio.rs` + `bridge_bio_cross.rs` |
...
- Path L (Molecular Biology→SDF→Analytics/DB/Cache)
